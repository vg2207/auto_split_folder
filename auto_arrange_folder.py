...
if user_input_excel is not None:
    ...
    if user_input_folder is not None:
        ...
        with st.container():
            with col_1:
                user_input_npwp = st.text_input("Input nama kolom NPWP")
        with st.container():
            with col_2:
                user_input_perusahaan = st.text_input("Input nama kolom perusahaan")
        with st.container():
            with col_3:
                user_input_masa_pajak = st.text_input("Input nama kolom masa pajak")
        with st.container():
            with col_4:
                user_input_tahun_pajak = st.text_input("Input nama kolom tahun pajak")
        with st.container():
            with col_5:
                user_input_ID = st.text_input("Input nama kolom ID")
